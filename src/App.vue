  ...
  <div id="wrapper">
    <nav class="navbar is-dark">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>TCGStore</strong></router-link>
      ...
      <div class="navbar-menu" id="navbar-menu" v-bind:class="{'is-active': showMobileMenu }">
        ...
        <div class="navbar-end">
          <router-link to="/magic" class="navbar-item">Magic</router-link>
          <router-link to="/pokemon" class="navbar-item">Pokemon</router-link>
